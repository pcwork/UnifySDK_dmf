...
typedef enum {
  ...
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG = 0xFC42,
...
/*****************************************************************
 *
 * ZCL attributes for DMFBridgeConfig cluster
 *
 *****************************************************************/

/**
 * @brief ZCL attribute types for DMFBridgeConfig cluster
 */
typedef enum {
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_ATTR_FIXTURE_TABLE_REVISION = 0x01,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_ATTR_GROUP_TABLE_REVISION = 0x02,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_ATTR_SCENE_TABLE_REVISION = 0x03,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_ATTR_LIGHT_MODE_TABLE_REVISION = 0x04,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_ATTR_SCHEDULE_TABLE_REVISION = 0x05,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_ATTR_TOTAL_FIXTURES_COUNT = 0x10,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_ATTR_DISCOVERY_STATUS = 0x11,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_ATTR_BLE_SESSION_STATUS = 0x12,
} zigpc_zcl_dmf_bridge_config_attr_type_t;

/*****************************************************************
 *
 * ZCL Command support for DMFBridgeConfig cluster
 *
 *****************************************************************/

/**
 * @brief ZCL command types for DMFBridgeConfig cluster
 */
typedef enum {
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_TRIGGER_RDM_DISCOVERY = 0x00,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_GENERIC_COMMAND_RESPONSE = 0x00,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_IDENTIFY_FIXTURE = 0x01,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_IDENTIFY_ZONE = 0x02,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_PLAY_LIGHT_MODE = 0x03,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_GENERIC_READ_RECORD = 0x10,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_GENERIC_REPORT_RECORD = 0x10,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_GENERIC_WRITE_RECORD = 0x11,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_GENERIC_DELETE_RECORD = 0x12,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_CLEAR_TABLE = 0x13,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_ZB_NETWORK_LEAVE = 0x14,
  ZIGPC_ZCL_CLUSTER_DMF_BRIDGE_CONFIG_COMMAND_RAW_FIXTURE_NOTIFICATION = 0x15,
} zigpc_zcl_dmf_bridge_config_command_type_t;
