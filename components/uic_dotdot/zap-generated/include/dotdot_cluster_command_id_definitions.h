...
// Commands for cluster: DMFBridgeConfig
#define DOTDOT_DMF_BRIDGE_CONFIG_TRIGGER_RDM_DISCOVERY_COMMAND_ID (0x0)
#define DOTDOT_DMF_BRIDGE_CONFIG_GENERIC_COMMAND_RESPONSE_COMMAND_ID (0x0)
#define DOTDOT_DMF_BRIDGE_CONFIG_IDENTIFY_FIXTURE_COMMAND_ID (0x1)
#define DOTDOT_DMF_BRIDGE_CONFIG_IDENTIFY_ZONE_COMMAND_ID (0x2)
#define DOTDOT_DMF_BRIDGE_CONFIG_PLAY_LIGHT_MODE_COMMAND_ID (0x3)
#define DOTDOT_DMF_BRIDGE_CONFIG_GENERIC_READ_RECORD_COMMAND_ID (0x10)
#define DOTDOT_DMF_BRIDGE_CONFIG_GENERIC_REPORT_RECORD_COMMAND_ID (0x10)
#define DOTDOT_DMF_BRIDGE_CONFIG_GENERIC_WRITE_RECORD_COMMAND_ID (0x11)
#define DOTDOT_DMF_BRIDGE_CONFIG_GENERIC_DELETE_RECORD_COMMAND_ID (0x12)
#define DOTDOT_DMF_BRIDGE_CONFIG_CLEAR_TABLE_COMMAND_ID (0x13)
#define DOTDOT_DMF_BRIDGE_CONFIG_ZB_NETWORK_LEAVE_COMMAND_ID (0x14)
#define DOTDOT_DMF_BRIDGE_CONFIG_RAW_FIXTURE_NOTIFICATION_COMMAND_ID (0x15)
