...
#define DOTDOT_DMF_BRIDGE_CONFIG_FIXTURE_TABLE_REVISION_ATTRIBUTE_ID ((dotdot_attribute_id_t)0x1)
#define DOTDOT_DMF_BRIDGE_CONFIG_GROUP_TABLE_REVISION_ATTRIBUTE_ID ((dotdot_attribute_id_t)0x2)
#define DOTDOT_DMF_BRIDGE_CONFIG_SCENE_TABLE_REVISION_ATTRIBUTE_ID ((dotdot_attribute_id_t)0x3)
#define DOTDOT_DMF_BRIDGE_CONFIG_LIGHT_MODE_TABLE_REVISION_ATTRIBUTE_ID ((dotdot_attribute_id_t)0x4)
#define DOTDOT_DMF_BRIDGE_CONFIG_SCHEDULE_TABLE_REVISION_ATTRIBUTE_ID ((dotdot_attribute_id_t)0x5)
#define DOTDOT_DMF_BRIDGE_CONFIG_TOTAL_FIXTURES_COUNT_ATTRIBUTE_ID ((dotdot_attribute_id_t)0x10)
#define DOTDOT_DMF_BRIDGE_CONFIG_DISCOVERY_STATUS_ATTRIBUTE_ID ((dotdot_attribute_id_t)0x11)
#define DOTDOT_DMF_BRIDGE_CONFIG_BLE_SESSION_STATUS_ATTRIBUTE_ID ((dotdot_attribute_id_t)0x12)
